...
func TestProtocolStableUnreachableSettlementWiring(t *testing.T) {
	...
	tests := []protocolSettlementWiringTest{
		{name: "icmp4", res: &icmp4.res, final: &icmp4.final, launch: func() { icmp4.launchTTL(context.Background(), func(error) {}, nil, traceWiringTestTTL) }, wait: icmp4.wg.Wait, send: func(ctx context.Context) error { return icmp4.send(ctx, nil, traceWiringTestTTL, 0) }, setSem: func(sem *semaphore.Weighted) { icmp4.sem = sem }},
		{name: "icmp6", res: &icmp6.res, final: &icmp6.final, launch: func() { icmp6.launchTTL(context.Background(), func(error) {}, nil, traceWiringTestTTL) }, wait: icmp6.wg.Wait, send: func(ctx context.Context) error { return icmp6.send(ctx, nil, traceWiringTestTTL, 0) }, setSem: func(sem *semaphore.Weighted) { icmp6.sem = sem }},
		{name: "tcp4", res: &tcp4.res, final: &tcp4.final, launch: func() { tcp4.launchTTL(context.Background(), func(error) {}, nil, traceWiringTestTTL) }, wait: tcp4.wg.Wait, send: func(ctx context.Context) error { return tcp4.send(ctx, nil, traceWiringTestTTL, 0) }, setSem: func(sem *semaphore.Weighted) { tcp4.sem = sem }},
		{name: "tcp6", res: &tcp6.res, final: &tcp6.final, launch: func() { tcp6.launchTTL(context.Background(), func(error) {}, nil, traceWiringTestTTL) }, wait: tcp6.wg.Wait, send: func(ctx context.Context) error { return tcp6.send(ctx, nil, traceWiringTestTTL, 0) }, setSem: func(sem *semaphore.Weighted) { tcp6.sem = sem }},
		{name: "udp4", res: &udp4.res, final: &udp4.final, launch: func() { udp4.launchTTL(context.Background(), func(error) {}, nil, traceWiringTestTTL) }, wait: udp4.wg.Wait, send: func(ctx context.Context) error { return udp4.send(ctx, nil, traceWiringTestTTL, 0) }, setSem: func(sem *semaphore.Weighted) { udp4.sem = sem }},
		{name: "udp6", res: &udp6.res, final: &udp6.final, launch: func() { udp6.launchTTL(context.Background(), func(error) {}, nil, traceWiringTestTTL) }, wait: udp6.wg.Wait, send: func(ctx context.Context) error { return udp6.send(ctx, nil, traceWiringTestTTL, 0) }, setSem: func(sem *semaphore.Weighted) { udp6.sem = sem }},
	}
