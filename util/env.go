...
var (
	...
	EnvProxyURL     = GetSecretEnvDefault("NEXTTRACE_PROXY", "")
	EnvToken        = GetSecretEnvDefault("NEXTTRACE_TOKEN", "")
	...
	EnvDeployToken  = GetSecretEnvDefault("NEXTTRACE_DEPLOY_TOKEN", "")
	EnvMaxAttempts  = GetEnvInt("NEXTTRACE_MAXATTEMPTS", 0)
	EnvICMPMode     = GetEnvInt("NEXTTRACE_ICMPMODE", 0)
	GlobalpingToken = GetSecretEnvDefault("GLOBALPING_TOKEN", "")
)
